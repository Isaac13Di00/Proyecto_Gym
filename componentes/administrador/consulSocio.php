...
<head>
    ...
    <title>Krachtig Gym - Consultar socio</title>
</head>
<body>
    <?php include("./templates/tmplt_header.php");?>
    <section>
        <div class="head">
            <a2 class="title">Consultar Socios</a2>
        ...
        <div class="div-wrap">
            <div class="div-consulta">
                <div class="bloque">
                    <ul>
                        <li><label class="etiqueta">Vigencia: </label><label class="info">###</label></li><br>
                        <li><label class="etiqueta">Membresía: </label><label class="info">###</label></li><br>
                        <li><label class="etiqueta">Miembro desde: </label><label class="info">###</label></li><br>
                        <li><label class="etiqueta">Correo: </label><label class="info">###</label></li><br>
                    </ul>
                </div>
                <div class="bloque">
                    <ul>
