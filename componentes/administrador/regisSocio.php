...
<head>
    <meta charset="UTF-8">
    <title>Krachtig Gym - Registro usuario</title>
...
<body>
    ...
    <section>
        <a2 class="title">Registrar usuario</a2>
        <div class="div-wrap">
            
            <form class="info" method="POST" action="./utilidades/registroUsuario.php">
                <ul>
                    <li><label class="info-text">Membresía: </label><select name="membresia" class="info-text">
                        <option value="Sencilla">Sencilla</option>
                        <option value="Premium">Premium</option>
                    </select></li>
                    <label class="info-text">Vigencia:</label><input name="vigencia" class="info-text" type="date"/></li>
                    <br>
                    <br>
                    ...
                    <li>
                    <br>
                        <label class="info-text">Fecha de nacimiento:</label><input name="fecha_nacimiento" class="info-text" type="date"/></li>
                    ...
                    <li><label class="info-text">Colonia: </label><input name="colonia"  class="info-text" type="text"/></li>
