<?php
  ...
  $resultado = $mysqli->query("SELECT * as id, citas.idUsuario , usuario.nombre as nombre, citas.fecha as fecha, citas.asistencia as asistencia FROM citas JOIN usuario ON citas.idUsuario = usuario.id");
