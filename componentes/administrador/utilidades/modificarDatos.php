<?php
    ...
    if ($sexo != null AND $fecha_nacimiento != null AND $tipo_sangre != null AND $nombre != null AND $calle != null AND $colonia != null AND $cp != null) {
        $sql = "UPDATE `administrador` SET `sexo`='$sexo',`fecha_nacimiento`='$fecha_nacimiento',`tipo_sangre`='$tipo_sangre',`calle`='$calle',`colonia`='$colonia',`cp`='$cp',`nombre`='$nombre' WHERE `id` = $id";
